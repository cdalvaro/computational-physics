...
//  --- MORE OPERATORS ---
template <class T> inline cda::containers::Matrix<T>
operator*(const T& D, const cda::containers::Matrix<T>& M);                                    //  Define el producto de un escalar y una matriz por la izquierda.
template <class T> inline cda::containers::Matrix<T>
operator&&(const cda::containers::Matrix<T>& Mi, const cda::containers::Matrix<T>& Md);                           //  Devuelve una matriz que tendrá unidas dos matrices.
template <class T> inline void
operator||(cda::containers::Matrix<T>& Mi, cda::containers::Matrix<T>& Md);                                       //  Separa una matriz en dos.
template <class T> inline void
operator>>(std::istream& in, cda::containers::Matrix<T>& M);                                        //  Importa una matriz desde un fichero.
template <class T> inline std::ostream&
operator<<(std::ostream& out, const cda::containers::Matrix<T>& M);                                 //  Exporta la matriz a un ostream.
